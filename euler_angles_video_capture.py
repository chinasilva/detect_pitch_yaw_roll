...
def get_pitch_yaw_roll(img_dir,estimator,output_path):
    ...
    for img_file_name in img_lst:
        ...
        if pitch_yaw_roll is not None :
            ...
            logger.debug(f"pitch,yaw,roll:{pitch}，{yaw}，{roll}")
            # with 
...
if __name__ == '__main__':
    ...
    # img_dir = '/data/face_landmark/PFLD_68points_Pytorch/data/img-test'
    # output_path = '/data/face_landmark/PFLD_68points_Pytorch/data/test_out' 
    # get_pitch_yaw_roll(img_dir,estimator,output_path)
